...
public class ArraysPractice {
    ...
    public static void main(String[] args) {
        ...
        // create a variable that can 5 scores

        int [] scores = new int [5];  // [0, 0, 0, 0, 0]

        scores [1] = 85;
        scores[scores.length-1] = 95;  // 5.siradakini farkli olarak boyle yazdik
        scores [3] = 75;
        scores [0] = 65;
        scores [2] = 55;
        ...
        String [] months = {"January", "February", "March", "April", "May", "June",
                "July", "August", "September", "October", "November", "December" }; // 0 - 11
/*
...
*/
        ...
        for (int i = months.length-1; i >=0 ; i--) {   //tersten
            System.out.println(months[i]);
