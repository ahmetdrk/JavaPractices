...
public class ArraysUtility {
    ...
    // checks if the given integer is contained in the given array. returs boolean. contains (int [], int)
    ...
    // checks if the given double is contained in the given array. returs boolean. contains (double [], double)
    ...
    // checks if the given char is contained in the given array. returs boolean. contains
    ...
    // checks if the given string is contained in the given array. returs boolean.
